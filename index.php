    ...
    <div class="container-xxl bg-white p-0">
                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                <h1 class="display-2 text-white animated slideInDown mb-4">A melhor escola de jardim de infância para seu filho </h1>
                                <p class="fs-5 fw-medium text-white mb-4 pb-2">Para encontrar a melhor escola de jardim de infância com reforço <br/> escolar para seu filho, considere a proposta pedagógica, a estrutura física e o ambiente <br/> acolhedor. </p>
                                <a href="https://www.jcmh.org/pt/how-to-cope-when-your-childs-first-day-of-kindergarten-is-in-your-living-room/ "
                                    class="btn btn-primary rounded-pill py-sm-3 px-sm-5 me-3 animated slideInLeft">saber
                                    mais </a>
                                <a href="https://editoraopet.com.br/blog_opet/reforco-escolar-conheca-as-indicacoes-e-os-beneficios-desse-recurso-pedagogico/"
                                    class="btn btn-dark rounded-pill py-sm-3 px-sm-5 animated slideInRight">nossa
                                    aula </a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s"
                    ...
                    <p>As instalações da escola (salas de aula,
                        bibliotecas, etc.) são essenciais para criar um ambiente de aprendizagem
                        propício e eficaz. A escolha do espaço e a organização dos materiais
                        são cruciais para o sucesso do reforço,
                        permitindo que o aluno se concentre e aproveite ao máximo o tempo de
                        estudo.</p>
                </div>
                <div class="row g-4">
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s"
                        ...
                        <div class="facility-item">
                            ...
                            <div class="facility-text bg-primary">
                                <h3 class="text-primary mb-3">Onibus Escolar</h3>
                                <p class="mb-0">O objetivo principal é garantir o acesso à educação e o sucesso escolar de alunos, <br/>
                                    especialmente aqueles em áreas rurais ou com dificuldades de acesso. 
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s"
                        ...
                        <div class="facility-item">
                            ...
                            <div class="facility-text bg-success">
                                ...
                                <p class="mb-0">É importante considerar
                                    as necessidades e os interesses dos alunos, bem como a segurança e a
                                    adequação do espaço para as atividades propostas. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s"
                        ...
                        <div class="facility-item">
                            ...
                            <div class="facility-text bg-warning">
                                ...
                                <p class="mb-0">É importante para
                                    promover hábitos alimentares saudáveis e contribuir para o bem-estar dos
                                    alunos, além de fortalecer a educação alimentar.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s"
                        ...
                        <div class="facility-item">
                            ...
                            <div class="facility-text bg-info">
                                <h3 class="text-info mb-3">Aprendizagem positiva </h3>
                                <p class="mb-0">implica criar um ambiente onde o aluno se sinta motivado, seguro e
                                    engajado no processo de aprendizado.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s"
                        ...
                        <p>Um projeto de reforço escolar com atividades
                            ...
                            desenvolvimento de habilidades socioemocionais, criatividade e
                            aprofundamento de conhecimentos. </p>
                        <p class="mb-4">Ao integrar reforço escolar e atividades culturais, é possível criar um ambiente
                            de aprendizado mais completo e enriquecedor,
                            que contribui para o desenvolvimento integral dos alunos.</p>
                        <div class="row g-4 align-items-center">
                            <div class="col-sm-6">
                                <a class="btn btn-primary rounded-pill py-3 px-5" href="https://site.educacional.com.br/artigos/reforco-escolar ">Leia mais</a>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-12 text-center">
                                <img class="img-fluid w-75 rounded-circle bg-light p-3"
                                    src="modelo%20de%20site%20pr%C3%A9-escolar%20kider_arquivos/about-1.jpg" alt="">
                            </div>
                            <div class="col-6 text-start" style="margin-top: -150px;">
                                <img class="img-fluid w-100 rounded-circle bg-light p-3"
                                    src="modelo%20de%20site%20pr%C3%A9-escolar%20kider_arquivos/about-2.jpg" alt="">
                            </div>
                            <div class="col-6 text-end" style="margin-top: -150px;">
                                <img class="img-fluid w-100 rounded-circle bg-light p-3"
                                    src="modelo%20de%20site%20pr%C3%A9-escolar%20kider_arquivos/about-3.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s"
                    style="max-width: 600px; visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
                    <h1 class="mb-3">Aula Escolar</h1>
                    <p>É uma aula adicional destinada a apoiar alunos que estão com dificuldades em determinada
                        disciplina ou área de estudo.</p>
                </div>
                <div class="row g-4">
                        ...
                        <div class="classes-item">
                            <div class="bg-light rounded-circle w-75 mx-auto p-3">
                                <img class="img-fluid rounded-circle"
                                    src="modelo%20de%20site%20pr%C3%A9-escolar%20kider_arquivos/classes-1.jpg" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s"
                        ...
                        <div class="classes-item">
                            <div class="bg-light rounded-circle w-75 mx-auto p-3">
                                <img class="img-fluid rounded-circle"
                                    src="modelo%20de%20site%20pr%C3%A9-escolar%20kider_arquivos/classes-2.jpg" alt="">
                            </div>
                            <div class="bg-light rounded p-4 pt-5 mt-n5">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s"
                        ...
                        <div class="classes-item">
                            <div class="bg-light rounded-circle w-75 mx-auto p-3">
                                <img class="img-fluid rounded-circle"
                                    src="modelo%20de%20site%20pr%C3%A9-escolar%20kider_arquivos/classes-3.jpg" alt="">
                            </div>
                            <div class="bg-light rounded p-4 pt-5 mt-n5">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s"
                        ...
                        <div class="classes-item">
                            <div class="bg-light rounded-circle w-75 mx-auto p-3">
                                <img class="img-fluid rounded-circle"
                                    src="modelo%20de%20site%20pr%C3%A9-escolar%20kider_arquivos/classes-4.jpg" alt="">
                            </div>
                            <div class="bg-light rounded p-4 pt-5 mt-n5">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s"
                        ...
                        <div class="classes-item">
                            <div class="bg-light rounded-circle w-75 mx-auto p-3">
                                <img class="img-fluid rounded-circle"
                                    src="modelo%20de%20site%20pr%C3%A9-escolar%20kider_arquivos/classes-5.jpg" alt="">
                            </div>
                            <div class="bg-light rounded p-4 pt-5 mt-n5">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s"
                        ...
                        <div class="classes-item">
                            <div class="bg-light rounded-circle w-75 mx-auto p-3">
                                <img class="img-fluid rounded-circle"
                                    src="modelo%20de%20site%20pr%C3%A9-escolar%20kider_arquivos/classes-6.jpg" alt="">
                            </div>
                            <div class="bg-light rounded p-4 pt-5 mt-n5">
